...
<p>The lower-right corner is empty. To make that precise, take at each income level the 5th percentile of energy use: the least energy that any country of that wealth has ever run on.<label for="sn-floor" class="margin-toggle sidenote-number"></label><input type="checkbox" id="sn-floor" class="margin-toggle"><span class="sidenote">10,000&nbsp;kWh/yr is roughly a continuous 1.1&nbsp;kW draw, about eleven incandescent bulbs per person. That is the floor, not the average. Less wealthy countries should consider this minimum level of energy consumption as a goal for their country if they are to increase their wealth.</span> This lower envelope is essentially a lower bound on requisite energy consumption for your GDP, and it climbs monotonically: raise the income floor and the energy floor rises with it, with no exceptions across the entire range.</p>
<p>The most energy-frugal rich economy in the data is Macao&mdash;a casino-and-services city-state with essentially no industry, no agriculture, and no hinterland, which imports every joule-intensive thing it touches. The places that press hardest against the wall are exactly the ones typical economic theory predicts: financial and tourist enclaves that have outsourced their steel, cement, and freight to somewhere else. Even they only touch the floor. None has gone through it.</p>
</section>
